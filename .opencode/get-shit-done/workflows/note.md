...
- **Global scope**: `/home/tom/workspace/ai/made/workspace/askx/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/tom/workspace/ai/made/workspace/askx/.opencode/notes/`)
...
2. Glob `/home/tom/workspace/ai/made/workspace/askx/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/tom/workspace/ai/made/workspace/askx/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/tom/workspace/ai/made/workspace/askx/.opencode/notes/` — works in any directory
